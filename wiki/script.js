...
(function () {
  const T = {
    ...
    it: {
      ...
      "Ops & Reference": "Operazioni e riferimento",
      "A professional monitoring platform for Claude Code agent activity. Captures sessions, agents, and tool events via native hooks, persists them in SQLite, and streams updates to a React UI over WebSocket — with no external services required.":
        "Una piattaforma professionale di monitoraggio per l'attività degli agenti di Claude Code. Cattura sessioni, agenti ed eventi degli strumenti tramite hook nativi, li persiste in SQLite e trasmette gli aggiornamenti in streaming a una UI React tramite WebSocket, senza bisogno di servizi esterni.",
      "◈ Introduction": "◈ Introduzione",
      "System Overview": "Panoramica del sistema",
      "Hook latency": "Latenza degli hook",
      "Hook types captured": "Tipi di hook catturati",
      "Server memory": "Memoria del server",
      "Events before slowdown": "Eventi prima del rallentamento",
      "◈ Features": "◈ Funzionalità",
      "What's Included": "Cosa è incluso",
      "Live Dashboard": "Dashboard in tempo reale",
      ...
      "Activity Feed": "Feed delle attività",
      Analytics: "Analisi",
      "WebSocket Push": "Push WebSocket",
      Statusline: "Statusline",
      "History Import": "Importazione della cronologia",
      "Continuous Project Sync": "Sincronizzazione continua del progetto",
      "Transcript Cache": "Cache dei transcript",
      "Bounded Cache Memory": "Memoria della cache limitata",
      "Constant-Time Sweep": "Sweep a tempo costante",
      ...
      "Workflow Graphs": "Grafici del workflow",
      "Workflow Analytics": "Analisi del workflow",
      "Workflow Runs": "Esecuzioni del workflow",
      "Session Drill-In": "Approfondimento della sessione",
      ...
      "Concurrency Timeline": "Timeline della concorrenza",
      "VS Code Extension": "Estensione VS Code",
      "Error Propagation Map": "Mappa di propagazione degli errori",
      "Progressive Web App": "Progressive Web App",
      "Fresh-by-Default Caching": "Caching fresh-by-default",
      "Auto-Reload on Update": "Ricaricamento automatico all'aggiornamento",
      Screenshots: "Screenshot",
      "Hook Events Captured": "Eventi hook catturati",
      "◈ Getting Started": "◈ Per iniziare",
      ...
      "Alternative: Docker / Podman": "Alternativa: Docker / Podman",
      "Optional: Enable MCP and Agent Extensions": "Opzionale: abilitare le estensioni MCP e Agent",
      ...
      "Agent State Machine": "Macchina a stati dell'agente",
      "Session State Machine": "Macchina a stati della sessione",
      "Data Flow": "Flusso dei dati",
      "Event Ingestion Pipeline": "Pipeline di ingestione degli eventi",
      "Client Data Loading Pattern": "Pattern di caricamento dati del client",
      ...
      "Key Client Modules": "Moduli chiave del client",
      ...
      Metrics: "Metriche",
      "Hooks Ingestion": "Ingestione degli hook",
      Pricing: "Prezzi",
      Settings: "Impostazioni",
      "Import History": "Importazione della cronologia",
      Workflows: "Workflow",
      Alerts: "Avvisi",
      Webhooks: "Webhook",
      "WebSocket Protocol": "Protocollo WebSocket",
      "Message Envelope": "Envelope del messaggio",
      "◈ Integrations": "◈ Integrazioni",
      "Hook Integration": "Integrazione degli hook",
      "Hook Handler Design": "Progettazione dell'handler degli hook",
      "Hook Installation Flow": "Flusso di installazione degli hook",
      "Import Pipeline": "Pipeline di importazione",
      "Three Modes, One Pipeline": "Tre modalità, una sola pipeline",
      "Upload Request Sequence": "Sequenza della richiesta di upload",
      "Idempotence & Cost Accuracy": "Idempotenza e precisione dei costi",
      "Supported Source Layouts": "Layout delle sorgenti supportati",
      ...
      CLI: "CLI",
      "MCP & Agent Extensions": "Estensioni MCP e Agent",
      "Local MCP Server Runtime": "Runtime del server MCP locale",
      "Agent Extension Layout": "Layout dell'estensione Agent",
      "Root Helper Scripts": "Script helper di root",
      Installation: "Installazione",
      "Available Plugins": "Plugin disponibili",
      Plugin: "Plugin",
      "CLI Tools": "Strumenti CLI",
      "Skill Usage Examples": "Esempi di utilizzo delle skill",
      "Plugin Architecture": "Architettura dei plugin",
      "Data Model Reference": "Riferimento del modello dei dati",
      "Statusline Utility": "Utility Statusline",
      "Live Monitoring Sidebar": "Barra laterale di monitoraggio in tempo reale",
      "Interactive Analytics & Usage": "Analisi e utilizzo interattivi",
      "Embedded Dashboard & Deep Navigation": "Dashboard integrata e navigazione approfondita",
      ...
      "Menu-Bar / Notification-Area (Tray) Icon":
        "Icona nella barra dei menu / area di notifica (tray)",
      "Native Application Menu": "Menu applicativo nativo",
      "Auto-Start at Login": "Avvio automatico all'accesso",
      "Close Hides, Server Stays Up": "La chiusura nasconde, il server resta attivo",
      "Runs Alongside the Web Dashboard": "Funziona insieme alla dashboard web",
      "Single-Instance Lock": "Lock a istanza singola",
      ...
      "Port Discovery": "Individuazione della porta",
      "How to Get It": "Come ottenerlo",
      "Option A — download the latest GitHub Release (recommended)":
        "Opzione A — scaricare l'ultima GitHub Release (consigliato)",
      "Option B — per-commit CI artifact": "Opzione B — artefatto CI per singolo commit",
      "Option C — build locally": "Opzione C — build in locale",
      macOS: "macOS",
      ...
      Launch: "Avvia",
      Windows: "Windows",
      "Run the Installer": "Esegui l'installer",
      "Clear SmartScreen": "Sblocca SmartScreen",
      ...
      "System Health": "Stato di salute del sistema",
      "Notification Preferences": "Preferenze di notifica",
      "12 discovery tabs": "12 schede di scoperta",
      "Safe mutations": "Modifiche sicure",
      "Keybindings editor": "Editor delle scorciatoie da tastiera",
      "Memory store": "Archivio di memoria",
      "Read-only by design": "Sola lettura per progettazione",
      "Live refresh": "Aggiornamento in tempo reale",
      "Editable vs read-only": "Modificabile vs sola lettura",
      "API endpoints": "Endpoint API",
      "Rule types": "Tipi di regole",
      "Evaluation engine": "Motore di valutazione",
      "14 first-class providers": "14 provider di prima classe",
      "Delivery engine": "Motore di consegna",
      Security: "Sicurezza",
      "Guided setup": "Configurazione guidata",
      "Provider payloads": "Payload dei provider",
      "Update Notifier": "Notificatore di aggiornamenti",
      "Non-Blocking Detection": "Rilevamento non bloccante",
      "5-min Scheduler": "Scheduler ogni 5 minuti",
      "Situation-Aware Command": "Comando consapevole del contesto",
      "Two UI Surfaces": "Due superfici UI",
      "Soft Failure Semantics": "Semantica dei fallimenti soft",
      "Dismissal Memory": "Memoria delle chiusure",
      ...
      "Namespaced resources": "Risorse con namespace",
      "Detection & fallback": "Rilevamento e fallback",
      "Locale-aware formatting": "Formattazione consapevole della locale",
      "Technical terms preserved": "Termini tecnici preservati",
      "◈ Components & UI": "◈ Componenti e UI",
      "🐾 Tabby — Reactive Cat Companion": "🐾 Tabby — Compagno gatto reattivo",
      "Reactive Mascot — Eight Moods": "Mascotte reattiva — otto stati d'animo",
      "Auto-Surface Speech Bubbles": "Fumetti automatici",
      "The ⌘B Panel": "Il pannello ⌘B",
      "Ask → Run Claude Handoff": "Passaggio da Ask a Run Claude",
      "Accessibility & Resilience": "Accessibilità e resilienza",
      "◈ Operations": "◈ Operazioni",
      "Deployment Modes": "Modalità di deployment",
      "Container Runtime (Docker / Podman)": "Runtime dei container (Docker / Podman)",
      "Docker / Podman": "Docker / Podman",
      "Performance Characteristics": "Caratteristiche di prestazione",
      "Server startup": "Avvio del server",
      "Hook-to-broadcast latency": "Latenza da hook a broadcast",
      "JS bundle (63 KB gzipped)": "Bundle JS (63 KB con gzip)",
      "SQLite inserts/sec (WAL)": "Inserimenti SQLite/sec (WAL)",
      "Security Considerations": "Considerazioni sulla sicurezza",
      Troubleshooting: "Risoluzione dei problemi",
      "No sessions appearing after starting Claude Code":
        "Nessuna sessione compare dopo l'avvio di Claude Code",
      ...
      "Check 3 — Start a new Claude Code session":
        "Verifica 3 — Avvia una nuova sessione di Claude Code",
  ...
  const ATTRIBUTE_TRANSLATIONS = {
    "Command Palette open over the Sessions page": {
      ...
      it: "Palette dei comandi aperta sopra la pagina Sessioni",
    },
    "Wiki navigation": {
      zh: "维基导航",
      vi: "Điều hướng wiki",
    ...
    "Claude Code Agent Monitor dashboard showing live agent cards, stats, and recent activity feed":
      {
        ...
        it: "Dashboard di Claude Code Agent Monitor con card degli agenti in tempo reale, statistiche e feed dell'attività recente",
      },
    "Previous features": {
      zh: "上一组功能",
      vi: "Tính năng trước",
    ...
    "Session Detail — Agents tab": {
      ...
      it: "Dettaglio sessione — scheda Agenti",
    },
    "Task Progress panel on Session Detail": {
      ...
      it: "Pannello Avanzamento attività nel dettaglio sessione",
    },
    "Session Detail — Conversation tab": {
      ...
      it: "Dettaglio sessione — scheda Conversazione",
    },
    "Session Detail — Timeline tab": {
      ...
      it: "Dettaglio sessione — scheda Cronologia",
    },
    ...
    "Analytics Overview": {
      ...
      it: "Panoramica delle analitiche",
    },
    "Workflows Overview": {
      zh: "工作流概览",
    ...
    "Dynamic Workflow Runs on the Workflows page": {
      ...
      it: "Esecuzioni di workflow dinamici nella pagina Workflow",
    },
    "Dynamic Workflow Run expanded with phase filters and per-agent results": {
      ...
      it: "Esecuzione di workflow dinamico espansa con filtri di fase e risultati per agente",
    },
    "Dynamic Workflow Runs on the session detail page": {
      ...
      it: "Esecuzioni di workflow dinamici nella pagina di dettaglio sessione",
    },
    "Agent Config — Claude Code and Codex explorers": {
      ...
      it: "Config agente — explorer di Claude Code e Codex",
    },
    "Claude Config Explorer": {
      ...
      it: "Explorer di configurazione Claude",
    },
    "Codex Config Explorer — overview, configuration source, and workspace tabs": {
      ...
      it: "Explorer di configurazione Codex — schede panoramica, sorgente di configurazione e workspace",
    },
    "Claude Config Explorer — Skills tab": {
      ...
      it: "Explorer di configurazione Claude — scheda Skill",
    },
    "Run Agent — Claude Code and Codex launch selection": {
      ...
      it: "Esegui agente — selezione di avvio Claude Code o Codex",
    },
    "Run Agent — live streaming output": {
      ...
      it: "Esegui agente — output in streaming in tempo reale",
    },
    "Settings Overview": {
      zh: "设置概览",
    ...
    "Swagger UI API docs": {
      ...
      it: "Documentazione API Swagger UI",
    },
    "ReDoc API reference": {
      zh: "ReDoc API 参考",
    ...
    "Grafana CCAM — Overview dashboard": {
      ...
      it: "Grafana CCAM — dashboard di panoramica",
    },
    ...
    "Prometheus Graph with CCAM PromQL": {
      ...
      it: "Prometheus Graph con CCAM PromQL",
    },
    "Interactive Swagger UI rendering the dashboard's OpenAPI 3.0 spec, with collapsible endpoint groups, request/response schemas, and try-it-out controls":
      {
        ...
        it: "Swagger UI interattivo che presenta la specifica OpenAPI 3.0 della dashboard, con gruppi di endpoint comprimibili, schemi di richiesta/risposta e controlli try-it-out",
      },
    "ReDoc rendering the dashboard's OpenAPI 3.0 spec as a read-optimized three-panel reference, served self-hosted and fully offline":
      {
        ...
        it: "ReDoc presenta la specifica OpenAPI 3.0 della dashboard come riferimento a tre pannelli ottimizzato per la lettura, self-hosted e completamente offline",
      },
    "Settings page Import History section showing rescan default folder, scan custom path, and upload controls with progress output":
      {
        ...
        it: "Sezione Importa cronologia con riscansione della cartella predefinita, scansione di un percorso personalizzato e controlli di caricamento con output di avanzamento",
      },
    "Settings page Remote Data Sources section showing configured SSH sources with live status, the data-scope selector, and per-source sync controls":
      {
        ...
        it: "Sezione Fonti dati remote con origini SSH configurate, stato live, selettore dell'ambito dei dati e controlli di sincronizzazione per fonte",
      },
    "MCP Server interactive REPL showing the MCP Tools banner, server info, and tool listing with colored output":
      {
        ...
        it: "REPL interattivo del MCP Server con il banner MCP Tools, le informazioni del server e l'elenco degli strumenti con output colorato",
      },
    "CLI statusline showing model, user, git branch, context window bar, and token counts": {
      ...
      it: "Statusline della CLI con modello, utente, branch git, barra della finestra di contesto e conteggi dei token",
    },
    "VS Code Extension sidebar showing live health, analytics, and navigation": {
      ...
      it: "Barra laterale dell'estensione VS Code con stato, analitiche e navigazione in tempo reale",
    },
    ...
    "Claude Code Monitor running as a native desktop app on Windows, showing the Activity Feed, native Windows window menu, and Tabby companion":
      {
        ...
        it: "Claude Code Monitor come app desktop nativa su Windows, con il feed attività, il menu finestra nativo di Windows e il compagno Tabby",
      },
    "Windows NSIS installer step 1 — Choose Installation Options": {
      ...
      it: "Installer NSIS di Windows, passo 1 — Scegli le opzioni di installazione",
    },
    "Windows NSIS installer step 2 — Choose Install Location": {
      ...
      it: "Installer NSIS di Windows, passo 2 — Scegli la cartella di installazione",
    },
    "Windows NSIS installer step 3 — Completing Setup": {
      ...
      it: "Installer NSIS di Windows, passo 3 — Completamento dell'installazione",
    },
    "Settings page with model pricing editor, hook status, data management, and system info": {
      ...
      it: "Pagina Impostazioni con editor dei prezzi dei modelli, stato degli hook, gestione dati e informazioni di sistema",
    },
    "Claude Config Explorer — 12-tab inspector with overview counts, scope filter, and tab bar": {
      ...
      it: "Explorer di configurazione Claude — inspector a 12 schede con conteggi di panoramica, filtro per ambito e barra delle schede",
    },
    "Claude Config Explorer — Skills tab with searchable skill list and edit actions": {
      ...
      it: "Explorer di configurazione Claude — scheda Skill con elenco ricercabile e azioni di modifica",
    },
    "Settings — Alerts & Webhooks: rule list, fired-alert feed, and webhook channels": {
      ...
      it: "Impostazioni — Avvisi e Webhook: elenco delle regole, feed degli avvisi scattati e canali webhook",
    },
    "Update modal showing commits-behind count and copy-to-clipboard command": {
      ...
      it: "Modale di aggiornamento con il conteggio dei commit indietro e il comando da copiare negli appunti",
    },
    "Connection details modal with throughput sparkline, top event types, and recent activity": {
      ...
      it: "Modale dei dettagli di connessione con sparkline del throughput, tipi di evento principali e attività recente",
    },
    "Grafana CCAM — Overview dashboard with live fleet metrics": {
      ...
      it: "Grafana CCAM — dashboard di panoramica con metriche della flotta in tempo reale",
    },
    "Prometheus CCAM console landing page": {
      ...
      it: "Pagina iniziale della console Prometheus CCAM",
    },
    "Prometheus Graph UI running CCAM PromQL": {
      ...
      it: "Interfaccia Prometheus Graph che esegue CCAM PromQL",
    },
    "Tabby Companion": {
      zh: "Tabby 伴侣",
  ...
  const META = {
    ...
    it: {
      title: "Claude Code Agent Monitor - Wiki del progetto",
      description:
        "Wiki tecnica completa per Claude Code Agent Monitor: monitoraggio locale in tempo reale con integrazione del server MCP e scaffolding delle estensioni per Claude Code e Codex.",
      socialTitle: "Claude Code Agent Monitor - Wiki del progetto",
      socialDescription:
        "Wiki tecnica completa per Claude Code Agent Monitor: monitoraggio locale in tempo reale con integrazione del server MCP e scaffolding delle estensioni per Claude Code e Codex.",
      twitterDescription:
        "Monitoraggio locale in tempo reale dell'attività degli agenti Claude Code con integrazione MCP, scaffolding delle estensioni, analitiche e push WebSocket.",
      socialImageAlt:
        "Claude Code Agent Monitor — piattaforma di monitoraggio di Claude Code in tempo reale",
    },
  };
