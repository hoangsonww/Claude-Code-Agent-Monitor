...
import snapshots_en from "./locales/en/snapshots.json";
import snapshots_zh from "./locales/zh/snapshots.json";
import snapshots_vi from "./locales/vi/snapshots.json";
