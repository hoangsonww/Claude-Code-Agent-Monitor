...
> [!TIP]
> Consulta también [README.md](./README.md) (English), [README-CN.md](./README-CN.md) (中文), [README-VN.md](./README-VN.md) (Tiếng Việt), [README-KO.md](./README-KO.md) (한국어) y [README-IT.md](./README-IT.md) (italiano). Este es el README en español.
...
La interfaz de usuario incluye selección de idioma para inglés (`en`), chino (`zh`), vietnamita (`vi`), coreano (`ko`), español (`es`) e italiano (`it`). El selector personalizado en forma de menú desplegable evita que la barra lateral se sature a medida que se agregan idiomas. Los recursos se cargan por espacio de nombres y la preferencia se conserva en el almacenamiento del navegador entre actualizaciones.

```mermaid
flowchart LR
    A["El usuario selecciona un idioma<br/>en / zh / vi / ko / es / it"] --> B["Detector i18next<br/>localStorage -> navigator"]
