...
- Every applicable source file (`.js/.ts/.tsx/.cjs/.mjs/.py/.sh/.css` — excluding `node_modules/`, `dist/`, `data/`, `.worktrees/`, minified/vendored, generated `wiki/i18n-content.js`, snapshots) MUST start with the header comment: a truthful file overview plus the exact line `@author Son Nguyen <hoangson091104@gmail.com>`.
